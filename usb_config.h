...
//#define HID_EP 					1
#define MOUSE_EP     			1
#define MOUSE_EP_SIZE           4
#define RPT_MOUSE_SIZE          52
//#define HID_EP2					2
#define JOYSTICK_EP             2
#define JOYSTICK_EP_SIZE        4
#define RPT_JOYSTICK_SIZE       49
//#define HID_EP3					3
#define KEYBOARD_EP             3
#define KEYBOARD_IN_SIZE        8
#define KEYBOARD_OUT_SIZE       1
#define RPT_KEYBOARD_SIZE       63
//#define HID_EP4					4
#define COM_EP					4
#define COM_IN_SIZE             64
#define COM_OUT_SIZE            64
#define RPT_COM_SIZE            29
